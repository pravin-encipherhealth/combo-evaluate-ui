...
import { getAuthUser, clearAuthUser, roleColor, canManageUsers, type AuthUser } from '@/lib/auth'
  ...
  const sidebarContent = (
    <div className="flex h-full flex-col">
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
        ...
        {user && canManageUsers(user.roleId) && (
          <>
            <div className="pt-4 pb-1">
              <p className="px-3 text-xs font-semibold uppercase tracking-wider text-slate-500">Admin</p>
            </div>
